...
def resnet101(base_class, pretrained=False, progress=True, **kwargs):
    """Constructs a ResNet-50 model.
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet(base_class, 'resnet101', Bottleneck, [3, 4, 23, 3], pretrained, progress,
                   **kwargs)

def resnet152(base_class, pretrained=False, progress=True, **kwargs):
    """Constructs a ResNet-50 model.
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet(base_class, 'resnet152', Bottleneck, [3, 8, 36, 3], pretrained, progress,
                   **kwargs)